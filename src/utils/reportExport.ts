export const printReport = (title: string, subtitle: string, rows: Array<{ label: string; value: string | number }>, table?: { headers: string[]; rows: Array<Array<string | number>> }) => {
  // A aba precisa ser aberta diretamente pelo clique do usuário. Em alguns navegadores,
  // o uso de noopener no terceiro argumento retorna null mesmo quando o pop-up foi aceito.
