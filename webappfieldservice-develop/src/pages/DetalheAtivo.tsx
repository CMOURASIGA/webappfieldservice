...
export const DetalheAtivo = () => {
  ...
  // Timeline events
  const timeline = [
    ...requests.map(r => ({ date: r.createdAt, type: 'Solicitação', title: r.title, link: `/servicos/${r.id}`, status: r.status })),
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 flex flex-col items-center text-center justify-center space-y-2 h-full">
            ...
            <p className="text-xs text-slate-500 font-medium">altima Intervenção</p>
