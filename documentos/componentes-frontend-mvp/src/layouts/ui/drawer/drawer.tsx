...
export function Drawer({ children, id, width = "700px" }: DrawerProps) {
  ...
  return (
    <>
      <div
        ...
        className={cn(
          "fixed inset-0 bg-black bg-opacity-60 transition-opacity duration-500 z-40",
          {
      ...
      <div
        ...
        className={cn(
          "fixed top-0 right-0 h-full bg-white shadow-xl z-50 flex flex-col transition-transform duration-500 w-full lg:w-auto",
